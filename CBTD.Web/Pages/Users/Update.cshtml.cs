...
namespace CBTD.Web.Pages.Users;
...
public class Update : PageModel
{
     private readonly UnitOfWork _unitOfWork;
        ...
        public Update(UnitOfWork unitOfWork, UserManager<IdentityUser> userManager, RoleManager<IdentityRole> roleManager)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            return RedirectToPage("./Index", new { sucess = true, message = "Update Successful" });
        }
